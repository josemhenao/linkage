# Generated by Django 2.0.6 on 2019-01-16 17:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['id_ciudad', 'ciudad', 'departamento', 'estado'],
            },
        ),
        migrations.CreateModel(
            name='Departamento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ManyToManyField(blank=True, null=True, to='lugares.Categoria', verbose_name='Lista of categorias')),
